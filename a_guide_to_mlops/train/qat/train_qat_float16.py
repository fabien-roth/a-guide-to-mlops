...
def main():
    ...
    # Apply quantization-aware training (QAT) with float16 quantization
    ...
    keras_backup_path = model_folder / "celestial_bodies_classifier_model_float16.keras"
    ...
    try:
        ...
        onnx_output_path = model_folder / "celestial_bodies_classifier_model_float16.onnx"
    ...
    try:
        quantized_model_path = model_folder / "celestial_bodies_classifier_model_float16_quantized.onnx"
    ...
    try:
        ...
        bentoml.onnx.save_model(
            "celestial_bodies_classifier_model_float16",
            quantized_model,
