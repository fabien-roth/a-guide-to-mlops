...
def main():
    ...
    onnx_path = model_folder / "celestial_bodies_classifier_qat.onnx"
    dummy_input = torch.randn(1, input_channels, *image_size, dtype=torch.float32)
    ...
    quantized_onnx_path = model_folder / "celestial_bodies_classifier_qat_quantized.onnx"
    quantize_dynamic(
    ...
    print(f"Quantized ONNX model saved at {quantized_onnx_path}", flush=True)
    ...
    bentoml_model_name = "celestial_bodies_classifier_qat"
